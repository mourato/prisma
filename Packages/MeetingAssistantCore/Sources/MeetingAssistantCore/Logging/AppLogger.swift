...
public enum AppLogger {
    ...
    public static func warning(_ message: String, category: LogCategory, extra: [String: Any]? = nil) {
        let logger = Logger(subsystem: subsystem, category: category.rawValue)
        let formattedMessage = self.format(message, extra: extra)
    ...
    public static func fault(_ message: String, category: LogCategory, error: Error? = nil, extra: [String: Any]? = nil) {
        let logger = Logger(subsystem: subsystem, category: category.rawValue)
        var detailedMessage = message
