...
This directory contains **always-on rules** that apply to all tasks.

## Core Rules

| Rule | Description |
|------|-------------|
| [architecture.md](architecture.md) | MVVM + Clean Architecture patterns |
...
- **Skills** (conditional): `.agent/skills/` - Detailed guides for specific domains
- **AGENTS.md** - Main development guide with commands and references
