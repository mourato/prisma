...
description: This skill should be used when managing complex Git histories, rebasing, cherry-picking, or troubleshooting repository issues with bisect and reflog.
---
