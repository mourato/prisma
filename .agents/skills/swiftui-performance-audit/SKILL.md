...
description: This skill should be used when the user asks to "fix janky SwiftUI scrolling", "reduce excessive view updates", "diagnose layout thrash", or "audit SwiftUI runtime performance".
---
